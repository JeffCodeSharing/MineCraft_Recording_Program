...
public class ColorTool {
     ...
     */
    public static Color english_to_color(String s) {
     ...
     * @return 所有颜色名称的数组
     */
    public static String[] get_colors_name() {
        return new String[]{
     ...
     */
    public static String chinese_to_english(String chinese) {
     ...
     */
    public static String english_to_chinese(String english) {
