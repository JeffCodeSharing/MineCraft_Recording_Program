...
public class SetPositionData extends Application implements AbstractWindow {
    ...
    public void draw_controls(Group group) {
        ...
        confirm.setOnAction(actionEvent -> {
            ...
            if (index != -1) {
                position_details_show(group, index);
            }
        });
     ...
     * @param index 选中的位置索引
     */
    private void position_details_show(Group group, int index) {
        group.getChildren().clear();
        ...
        ComboBox<String> color_box = WinTool.createComboBox(60, 215, 100, 30, false,
                ColorTool.english_to_chinese(values[4]), ColorTool.get_colors_name());
        ...
        change.setOnAction(actionEvent -> save_events(
        ...
        return_menu.setOnAction(actionEvent -> draw_controls(group));
     ...
     * @param index      选中的位置索引
     */
    private void save_events(String x, String y, String z, String notes, String color, int index) {
        ...
        box.getChildren().set(controls_num, WinTool.createLabel(0, 0, 630, 25, 18, add_value,
                ColorTool.english_to_color(values[4])));
