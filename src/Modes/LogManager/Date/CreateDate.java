...
public class CreateDate extends Application implements AbstractWindow {
    ...
    public void draw_controls(Group group) {
        ...
        confirm.setOnAction(actionEvent -> {
            if (check_date(year_field, month_field, day_field)) {
                global_stage.close();
            }
        });
     ...
     */
    private boolean check_date(TextField year, TextField month, TextField day) {
        try {
     ...
     */
    private Integer[] return_day_of_month(int year) {
