...
public class SetLocking {
     ...
     * @param password 解锁密码
     */
    private void lock_confirm(String password) {
        String[] file_data = IOTool.read_file(path);
     ...
     * @param password 解锁密码
     */
    private void unlock_confirm(String password) {
        String[] file_data = IOTool.read_file(path);
        String[] seed_data = file_data[1].split("\0");
